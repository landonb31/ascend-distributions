-- Ascend Distributions: run this entire file in Supabase SQL Editor
-- https://supabase.com/dashboard/project/xmlkztmaiiuqbfksunwb/sql/new
...
CREATE TABLE public.tracks (
  ...
  audio_url TEXT,
  audio_format TEXT CHECK (audio_format IN ('wav', 'mp3', 'm4a', 'flac', 'aiff', 'wma')),
  isrc TEXT,
